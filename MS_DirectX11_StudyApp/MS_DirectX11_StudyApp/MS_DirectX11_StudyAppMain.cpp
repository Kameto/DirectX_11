#include "pch.h"
#include "MS_DirectX11_StudyAppMain.h"
#include "Common\DirectXHelper.h"

using namespace MS_DirectX11_StudyApp;
using namespace Windows::Foundation;
using namespace Windows::System::Threading;
using namespace Concurrency;

// アプリケーションの読み込み時にアプリケーション資産を読み込んで初期化します。
MS_DirectX11_StudyAppMain::MS_DirectX11_StudyAppMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
MS_DirectX11_StudyAppMain::~MS_DirectX11_StudyAppMain()
{
	// デバイスの通知を登録解除しています
...
void MS_DirectX11_StudyAppMain::CreateWindowSizeDependentResources() 
{
...
void MS_DirectX11_StudyAppMain::Update() 
{
	// シーン オブジェクトを更新します。
	m_timer.Tick([&]()
	{
...
bool MS_DirectX11_StudyAppMain::Render() 
{
...
void MS_DirectX11_StudyAppMain::OnDeviceLost()
{
...
void MS_DirectX11_StudyAppMain::OnDeviceRestored()
{
